...
control_duration = 1 # 3 # (sec.) detemines the frequency of choosing new control actions
...
sensor_angle_range = [-2*pi/5, 2*pi/5] # -pi/2 < < pi/2
sensor_max_range = 2
sensor_dpi = 150 # base value is 100, increase to increase sensor "sensitivity" (and observation visulizer resolution)
